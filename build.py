...
"""
Script to build OpenSSL for RACE
"""
...
if __name__ == "__main__":
    ...
    builder.install_packages(args, ["perl-modules-5.30"])

    builder.fetch_source(
        args=args,
        source=f"https://github.com/openssl/openssl/archive/refs/tags/OpenSSL_{args.version.replace('.', '_')}.tar.gz",
        extract="tar.gz",
    )
